...
import { Package, Lock, Mail, Loader2, Moon, Sun, ArrowRight } from 'lucide-react';
            ...
            <div className="max-w-md w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/20 dark:border-slate-800/50 z-10">
                <div className="bg-sky-600 p-8 text-white text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        ...
                        <p className="text-sky-100 mt-1 font-medium">Gestion de Stock Médical</p>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-5">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <input 
                                type="email" 
                                required
                                className="w-full pl-11 pr-4 py-3 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 dark:text-white rounded-xl focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all outline-none"
                    ...
                    <button 
                        type="submit" 
                        disabled={loading}
                        className="w-full bg-sky-600 hover:bg-sky-700 text-white font-bold py-3.5 rounded-xl shadow-lg shadow-sky-200 dark:shadow-none transition-all active:scale-[0.98] flex items-center justify-center gap-2 mt-2 disabled:opacity-70"
                    >
                    ...
                    <div className="pt-4 border-t border-slate-100 dark:border-slate-800 text-center">
                        <p className="text-slate-500 dark:text-slate-400 text-sm">
                            ...
                            <Link to="/register" className="text-sky-600 dark:text-sky-400 font-bold hover:underline inline-flex items-center gap-1 group">
                                Créer un compte
